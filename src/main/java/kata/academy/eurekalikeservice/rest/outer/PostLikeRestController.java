...
public class PostLikeRestController {
    ...
    public Response<PostLike> addPostLike(@RequestBody @Valid PostLikePersistRequestDto dto,
        ...
        ApiValidationUtil.requireFalse(postLikeService.existsByPostIdAndUserId(postId, userId), String.format("Реакция на пост с postId %d пользователя с userId %d уже была добавлена", postId, userId));
