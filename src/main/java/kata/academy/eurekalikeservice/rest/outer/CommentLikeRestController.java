...
public class CommentLikeRestController {
    ...
    public Response<CommentLike> addCommentLike(@RequestBody @Valid CommentLikePersistRequestDto dto,
        ...
        ApiValidationUtil.requireFalse(commentLikeService.existsByCommentIdAndUserId(commentId, userId), String.format("Реакция на комментарий с commentId %d пользователя с userId %d уже была добавлена", commentId, userId));
